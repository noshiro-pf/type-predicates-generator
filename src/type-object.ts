...
export type SpecialTO = Readonly<{
  __type: "SpecialTO"
  kind: "null" | "undefined" | "any" | "unknown" | "never" | "void" | "Date"
}>

export type LiteralTO = Readonly<{
  __type: "LiteralTO"
  value: unknown
}>
...
export type TypeParameterTO = Readonly<{
...
// サポートしてない型(スキップする)
export type SkipTO = Readonly<{
  __type: "SkipTO"
}>

// 分岐を抜けた未知の型
export type UnknownTO = Readonly<{
  __type: "UnknownTO"
